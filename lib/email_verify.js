// import ejs to render the template
...
// import the ejs template

let emailTemplate = async () =>{
   try {
      let params = {
        capitalizedFirstName: "Mark",
        lastName: "Essien",
        userEmail: "mark@essien.com",
        confirm_link: "http://www.zurichat.com/confirm=" + userEmail
      };
      let renderEjs = await ejs.renderFile(__dirname, "views/emailVerification.ejs", params)
      return renderEjs
    } catch (error) {
