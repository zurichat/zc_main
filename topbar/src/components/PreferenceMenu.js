    ...
    <div className={styles.notifySidebar}>
      <div className={styles.itemsContainer}>
        ...
        >
          <p>
            {' '}
            <AiOutlineEye className={styles.icon} /> Themes
          </p>
        </div>
        <div
        ...
        >
          <p>
            <FiMessageCircle className={styles.icon} /> Messages & Media
          </p>
        </div>
        <div
        ...
        >
          <p>
            <FiGlobe className={styles.icon} /> Languages & Region
          </p>
        </div>
        <div
        ...
        >
          <p>
            <AiOutlineSetting className={styles.icon} /> Advanced
          </p>
        </div>
      </div>
    </div>
