    ...
    <div className={styles.notifySidebar}>
      <div className={styles.itemsContainer}>
        ...
        >
            ...
            <BsLayoutSidebar className={styles.icon} /><p>Sidebar</p>
        </div>
        <div
        ...
        >
            ...
            <AiOutlineEye className={styles.icon} /><p>Themes</p>
        </div>
        <div
        ...
        >
            ...
            <FiMessageCircle className={styles.icon} /><p>Messages & Media</p>
        </div>
        <div
        ...
        >
            ...
            <FiGlobe className={styles.icon} /><p>Languages & Region</p>
        </div>
        <div
        ...
        >
            ...
            <FiVideo className={styles.icon} /><p> Audio & Video
          </p>
        </div>
        <div
