  ...
  return (
    <div>
        <div className={styles.containerAccessibility}>
            ...
            <p className={styles.accessibilityP}>Choose which sounds and announcements you'd like to receive while using a 
                <br />screen reader inside a direct message.</p>
            <form action="">
                    <div className={styles.imagesAndEmojis}>
                        <input
                            className={styles.accessibilityCheckbox}
            ...
            <p className={styles.accessibilityP}>You can improve the way you use Zurichat by learning our <span id={styles.handyKeyboard}>handy keyboard shortcuts.</span></p>
            
            <hr className={styles.hrLine}/>

            <h3 className={styles.pressH3}>Press in the empty message field to:</h3>
            <form action="">
                    <div className={styles.imagesAndEmojis}>
                        <input
                        ...
                        <p className={styles.accessibilityP} id={styles.accessibilityPId}>The last visible message in the list will be selected</p>
                    </div>
                    <div className={styles.imagesAndEmojis}>
                        <input
                            className={styles.accessibilityRadio}
                        ...
                        <p className={styles.accessibilityP} id={styles.accessibilityPId2}>The last visible message you sent will be selected and in the editing mode</p>
                    </div>
                </form>
                ...
                <span className={styles.accessibilityEsc} id={styles.exclamation}> ! </span> to edit your last message, with either option.
                </p>
            </div>
        </div>
      </div>
