...
import Header from "../externalPagesComponents/Header.js"
...
export default function App() {
  ...
  <div>
    ...
    <input type="text" className={styles.searchBar} placeholder="Frequently asked questions"/>
    ...
    <div className={styles.articleI}>
      ...
      <div className={styles.subArticleI}>
        <div style={{ backgroundImage: `url(${BlogImage})` }} className={styles.blogImage} />
        <div>
          <p>COLLABORATION</p>
          <h1>
