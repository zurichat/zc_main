...
import navlogo from '../../assets/image/hngLogo.png'
          ...
          <ul className={`navbar-nav ${navStyles.navbarNav}`}>
            <li className="nav-item">
              <Link
                ...
                aria-current="page"
              >
                <span className={`${navStyles.features}`}>Features</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link
                ...
                aria-expanded="false"
              >
                <span className={`${navStyles.pricing}`}>Pricing</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link
              ...
              >
                <span className={`${navStyles.comms}`}>Community</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link
                ...
                aria-expanded="false"
              >
                <span className={`${navStyles.download}`}>Downloads</span>
              </Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              ...
              >
                <span className={`${navStyles.signU}`}>Sign Up</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link
                ...
                role="button"
              >
                <span className={`${navStyles.signI}`}>Sign In</span>
              </Link>
            </li>
          </ul>
        </div>
