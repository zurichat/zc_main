...
const MarketPlaceContainer = () => {
  ...
  let modalData = marketplace.pluginId ? registeredPlugins.filter(plugins => plugins.id === marketplace.pluginId) : []
  ...
  return (
    ...
    })}
    {
      ...
      <Modal show={marketplace.modal} onHide={() => marketplace.setPluginId(null)} dialogClassName={styles.marketplaceModal}> 
        <div className={`d-flex flex-column justify-content-center ${styles.marketplaceModalTop}`}>
          ...
          <Row className="justify-content-between w-75 align-self-center align-items-center">
            ...
            <Col md={7} className="px-0">
              <p className={`${styles.modalDownloadAmount} px-0 mb-0`}>15k downloads</p>
            </Col>                
          </Row>   
