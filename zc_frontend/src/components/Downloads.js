...
const Downloads = ({setModal}) => {
  ...
  <>
    ...
    >
      <div className={styles.overlay}  onClick={() => {setModal("no")}}></div>
      <div className={styles.downloadsModal} >
        ...
        <div className={styles.iconContainer}>
         ...
         <svg
            ...
            <svg onClick={() => {setModal("no")}} className={styles.closeIcon} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <article className={styles.downloadsBody}>
         { !files && <div className={styles.info}>        
            <h4 className={styles.heading}>Keep track of your downloads</h4>
            <p className={styles.content}>Files you download from zurichat to your computer will appear here.</p>
          </div>
          }
          {
