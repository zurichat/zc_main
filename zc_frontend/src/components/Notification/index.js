...
const Notification = () => {
    return (
        <div className={styles.notify}>
            ...
            <div className={styles.msg}>Include preview message in notification</div>
            </form>
            ...
            <div className={styles.msg3}>Set your notifications right (Message)</div>
            <div className={styles.dropdown}>
            <select className={styles.button2}>
                <option value="rising-tune">Rising Tune</option>
                <option value="ding-dong">Ding Dong</option>
                <option selected value="pick-sound">Pick Sound</option>
                <option value="ring">Ring</option>
            </select>
            </div>
            </div>
            <div className={styles.lounge}>
            <div className={styles.msg4}>Set your notifications right (Lounge)</div>
            ...
            <div className={styles.text2}>Flash window when notification comes</div>
            </div>
            ...
            <div className={styles.text3}>When I am not active on desktop</div>
            </div>
            ...
            <select className={styles.button5}>
                ...
                <option selected value="online">When I am online</option>
            </select>
            </div>
            </div>
            ...
            <div className={styles.msg5}>Send me email notifications for mentions</div>
            </form>
            </div>
            </div>
            </div>
