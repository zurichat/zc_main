        ...
        <div className={styles.section4}>
            ...
            <div className={styles.funSection}>
                ...
                <div className={styles.funText}>
                    ...
                    <p>With zuri Chat, it’s not just all 
                        about work. while, you work, you 
                        can have fun with your team mates with 
                        our games plugins as well as listen to 
                        fun music. Share fun times and things 
                        with co-workers and build the team spirit 
                    </p>
                </div>
            </div>
        </div>
