        ...
        <div>
            <div className={styles.container}>
                <div>
                    ...
                    <form action="">
                        <div>
                            <input className={styles.viewChannel} type="radio" name="view-channel"
                        ...
                        <div>
                            <label className={styles.markAll} htmlFor="prompt to confirm">
                                <input className={styles.prompt}
                                    type="checkbox" value="Prompt to confirm" checked="checked"/>
                ...
                <div>
                    ...
                    <div>
                        <ul>
                            ...
                            <li className={styles.shortcut}>Mark all messages as read
                                <span className={styles.esc}>Shift</span>
                                {' '} {' '}
                                <span className={styles.esc}>Esc</span> </li>
                            <li className={styles.shortcut}>Mark a message as unread
                                <span className={styles.esc}>Alt </span> {' '} {' '}
                                and click message</li>
                        </ul>
                        <p className={styles.shortcutP}>And that’s just the beginning.
                            To view the full list of keywords shortcuts,
                            just press <br />
