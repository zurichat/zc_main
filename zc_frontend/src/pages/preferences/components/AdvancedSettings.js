          ...
          <div className={styles.input}>
                ...
                <div className={styles.radio}>
                  ...
                  <div className={styles.radiostart}>
                    <input type="radio" name="" id="" />
                    <div className={styles.start}>Start a new line | use 
                    <button className={styles.btn}>Ctrl</button>
                    <button className={styles.btn}>Enter</button> to send ]</div>
                  </div>
                </div>
          </div>
          ...
          <div className={styles.search}>
              ...
              <div className="check">
                <div className={styles.checktype}>
                  ...
                  <div className={styles.behaviour}>
                   ...
                   <span> Starts a Zurichat chat</span> <br /> Overrides normal behaviour in search behaviour
                  </div>
                </div>
                <div className={styles.checkformat}>
                <input type="checkbox" name="" id="" />
                  <div className={styles.browser}>
                    ...
                    <span> Starts the quick switcher </span><br /> Overrides normal behaviour in some browsers
                  </div>
                </div>
              </div>
              ...
              <div className="barcontainer">
                <div className={styles.bar}>
                  <input type="text" className={styles.bartype} 
                  placeholder="Type a channel name..." name="" id="" />
                </div>
              </div>
          </div>
            ...
            <div className={styles.check}>
                ...
                <div className={styles.survey}>
                  ...
                  <p>
                    ...
                    <span> We're working to make Zurichat better. We'd always love to hear
                       your thoughts</span>
                  </p>
                </div>
