    ...
    return (
        <div className={styles.themeCont}>
           <div className={styles.title}>
               <div className={styles.text}>Change the appearance of Slack across all of your workspaces.</div>
           </div>
           ...
           <div className={styles.direct}>
               ...
               <div className={styles.mention}>Direct messages, mentions & network</div>
           </div> 
           <div className={styles.text2}>Automatically switch between light and dark themes when your <br/> system does.</div>
           ...
           <div className={styles.customize}>
                ...
                <div className={styles.custom}>Customize the look of your workspace. Feeling adventurous?</div>
