                ...
                <div className={styles.camera}>
                    ...
                    <div className={styles.select}>
                        <select name="" id="" className={styles.selectfirst}>
                            <option selected disabled>Integrated Webcam (Oc45:64d2)</option>
                ...
                <div className={styles.microphone}>
                    ...
                    <div className={styles.speaker}>
                        <div className={styles.selecttwo}>
                            <select name="" id="">
                                <option selected disabled>Default - Speakers/Headphones (Re...</option>
                    ...
                    <div className={styles.check}>
                        <div className={styles.checkset}>
                            ...
                            <div className={styles.set}>
                               <span className={styles.statuscall}> Set my status to "On a call..."</span> <br />
                                If you already have a status set, 
                                    ZuriChat won't change it.
                    ...
                    <div className={styles.check}>
                        <div className={styles.checkstatus}>
                            ...
                            <div className={styles.status}>
                               <span className={styles.statushuddle}> Set my status to "In a huddle..."</span> <br />
                                If you already have a status set, 
                                    ZuriChat won't change it.
                    ...
                    <div className={styles.check}>
                        <div className={styles.checkallow}>
                                ...
                                <div className={styles.allow}>
                                  <span className={styles.mute}>  Allow keyboard shortcut to Mute</span> <br />
