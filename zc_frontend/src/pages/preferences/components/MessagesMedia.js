...
const MessagesMedia = () => {
    return (
        <div className={styles.msgCon}>
           ...
           <div className={styles.change}>To change your full or display name, head to <p style={{color: "#00B87C"}}>your profile.</p></div>
           ...
           <div className={styles.info}>
               ...
               <div className={styles.current}>Display information about who is currently typing a message</div>
           </div> 
           ...
           <div className={styles.hexa}>
               ...
               <div className={styles.color}>Display color swatches next to hexadecimal values</div>
           </div>  
           <div className={styles.bottom3}></div>
           <div className={styles.emoji}>Emoji</div>
           <div className={styles.tone}>Default Skin Tone</div>
           <div className={styles.choose}>Choose the default skin tone that will be used whenever you use certain emojis in <br/> reactions and messages.</div>
           ...
           <div className={styles.versions}>Display the jumbo versions of emoji (up to 23 at a time!) in messages <br/> without text.</div>
           ...
           <div className={styles.images}>
               ...
               <div className={styles.files}>Show images and files uploaded to Zurichat</div>
           </div>
           <div className={styles.websites}>
               <div className={styles.checkbox7}>
                    <input type="checkbox" />
               </div>
               <div className={styles.linked}>Show images and files from linked websites</div>
           </div> 
           ...
           <div className={styles.upload}>You can upload any important email to Slack by forwarding it to a unique <br/> email address. Slackbot will deliver the email and you can keep it private or <br/> share it with your team.</div>
           <button className={styles.button}><div className={styles.forward}>Get a forwarding address</div></button>
        </div>
    )
}
