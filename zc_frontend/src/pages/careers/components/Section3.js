  ...
  return (
    <>
      <div className={`${styles.Section3}`}>
        ...
        <p>Zuri Internship is a 100% free, remote and fast paced training for young 
            professionals seeking to hon their tech skills and boost their resume.
        </p>
        <div className={`${styles.section3Cards}`}>
            <div>
                <h3>Frontend Development</h3>
                <p>This track deals with the aspect of your application that the users 
            ...
            <div>
                ...
                <p>This track deals with the aspect of the application the user does 
            ...
            <div>
                <h3>Design</h3>
                <p>This track deals with creating a graphic plan for an application. 
            ...
            <div>
                ...
                <p>The mobile track contains a list of tools and languages needed 
                    for a developer to create mobile applications. A mobile application 
            ...
            <div>
                ...
                <p>It encomprises the use of digital means and utilities to boost 
