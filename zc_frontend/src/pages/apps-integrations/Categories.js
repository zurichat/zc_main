   ...
   function Categories() {
    ...
    return ( 
        ...
        <div className={classes.header}>
            ...
            <button className={classes.icons} onClick={handleShuffle}> <BiChevronLeft/> </button>
            <button className={classes.icons} onClick={handleShuffle}> <BiChevronRight/> </button>
        ...
        <div className={classes.background} onClick={closeModal}>
            ...
            <div  className={classes.categoriesModal} showmodal={showModal} setshowmodal={setShowModal}> 
             <div     className={classes.headerx}>
        
                    <div className={classes.btn_close}>
                        <button className={classes.icons} onClick={closeModal} > <MdClose/> </button>
                     </div>
                    </div>
                     <div className={classes.linkContainer}>
                         {list.map((x, index) => ( 
