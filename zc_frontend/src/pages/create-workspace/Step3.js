...
const Step3 = () => {
    ...
    const input = <Input type="text" placeholder="Ex:adimchisylvester@yahoo.com"/>;
    ...
    return(
            ...
            <MainSection>
                ...
                <Heading>
                    Who do you email most about <br/><span> project-{`${projectname}`}</span>?
                </Heading>
                <Marketing>Give Zuri Chat a spin and add a few coworkers you talk with regularly.</Marketing>
                <InputSection>
                    {inputs}
                <InputLinkSection>
                    <AddLinkWrapper>
                ...
                <SharableLink>
                    ...
                    <a style={{color:"#00B87C",cursor:"pointer"}}>Get a sharable link  <span> instead</span></a>
