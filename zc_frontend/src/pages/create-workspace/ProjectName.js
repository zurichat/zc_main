    ...
    <div>
      <article className={ProjectNameCSS.wrapper}>
        ...
        <div className={ProjectNameCSS.centerWrapper}>
          ...
          <Link to={`${match.url}/step3`}><Button style={value.length > 1 ?  {backgroundColor:"#00b87c",color:"white",display:"flex",justifyContent:"center"}:{display:"flex",justifyContent:"center"}}>Continue</Button></Link>
