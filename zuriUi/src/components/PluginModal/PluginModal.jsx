...
import {AiOutlineUserAdd,AiOutlineBell,AiOutlineClose,AiOutlineStar,AiOutlineLock} from 'react-icons/ai'
          ...
          <DialogContents>
            <Tabs>
              <div>
                <ModalTopic>
                  <ChannelName>
                    # Announcements <AiOutlineStar size="24px" style={{marginLeft:'10px',cursor:'pointer'}}/>
                  </ChannelName>
                  <Button onClick={close}><AiOutlineClose size="20px" color="gray"/></Button>
                </ModalTopic>
        ...
        <div style={{margin:'0 5px'}}>
          <OverallWrapper>
            ...
            <EachSegment>
              ...
              <EditContent>This channel is for passing major announcements on tasks and important
                information. Stay updated by always checking here.
              </EditContent>
            </EachSegment>
            <EachSegment>
              <Label>Created By</Label>
              <FileContent>
                Stella on August 12,2021
              </FileContent>
            </EachSegment>
            <EachSegment>
          ...
          <FileWrapper>
            ...
            <EditContent>There aren't any files to be see here right now. But there could be - drag and drop
              any file into the message pane to add it to this conversation.
            </EditContent>
          </FileWrapper>
...
function MembersPanel(){
  return(
    <div>
      <Selection>
        <AiOutlineBell style={{position:'absolute',marginLeft:'10px',marginBottom:'10px'}}/>
