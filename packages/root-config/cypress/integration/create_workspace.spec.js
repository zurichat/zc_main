...
context("Create workspace page", () => {
  ...
  describe("should navigate to the create workspace page", () => {
    ...
    it("should navigate to the create workspace page only if the user is logged in", () => {
      ...
      cy.get("[data-cy=create_new_workspace_action_element]").as(
        "createWorkspaceActionElement"
      );
      ...
      cy.get("@createWorkspaceActionElement").click({ force: true });
      ...
      cy.get("[data-cy=create_workspace_continue_action_element]")
        .should("be.disabled")
        .as("createWorkspaceContinueActionElement");

      // Enter workspace name
      cy.get("[ data-cy=create_workspace_textfield]").type("test hub");

      // Submit and continue
      cy.get("@createWorkspaceContinueActionElement")
      ...
      cy.get("@createWorkspaceContinueActionElement").should("be.disabled");
