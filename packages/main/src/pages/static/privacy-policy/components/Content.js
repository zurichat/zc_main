            ...
            <div>
              <div className={Style.section}>
                ...
                <p className={Style.zurimission}>
                  ...
                  allow them to be more productive and successful. Central to
                  this mission is our commitment to be transparent about the
                  data we collect about you, how it is used and with whom it is
                  shared.
                </p>
                <p className={Style.privPol}>
                  This Privacy Policy applies when you use our Services
                  (described below). We offer our users{" "}
              ...
              <div>
                ...
                <div className={Style.applicabilityImage}>
                  ...
                  <p className={Style.appPrivPol1}>
                    ...
                    Zurichat’s mobile and desktop applications (collectively,
                    the “Services”), <Link to="/" title="Zurichat.com" /> and
                    other Zurichat websites (collectively, the “Websites”) and
                    other interactions (e.g., customer service inquiries, user
                    conferences, etc.) you may have with Zuri. If you do not
                ...
                <p className={Style.appPrivPol2}>
                  ...
                  other third-party products, services or businesses. In
                  addition, a separate agreement governs delivery, access and
                  use of the Services (the “Customer Agreement”), including the
                  processing of any messages, files or other content submitted
                  through Services accounts (collectively, “Customer Data”). The
                  organization (e.g., your employer or another entity or person)
                  that entered into the Customer Agreement (“Customer”) controls
                  its instance of the Services (its “Workspace”) and any
                  associated Customer Data. If you have any questions about
                  specific Workspace settings and privacy practices, please
                  contact the Customer whose Workspace you use. If you have an
                  account, you can check{" "}
                  <Link
                    to="/pricing"
                    title="http://Zurichat.com/account/team"
                  />
              ...
              <div className={Style.infoCollected}>
                ...
                <div className={Style.privbreakdown1}>
                  <p className={Style.paraPriv1}>
                    ...
                    supply Zurichat with an email address, phone number,
                    password, domain and/or similar account details. For details
                  ...
                  <p className={Style.paraPriv1}>
                    ...
                    Websites or Services and record it in log files. This log
                    data may include the Internet Protocol (IP) address, the
                    address of the web page visited before using the Website or
                    Services, browser type and settings, the date and time the
                    Services were used, information about browser configuration
                  ...
                  <p className={Style.paraPriv1}>
                    <u>*Location information</u>. We receive information from
                    you, your Customer and other third-parties that helps us
                    approximate your location. We may, for example, use a
                    business address submitted by your employer or an IP address
                    received from your browser or device to determine
                    approximate location. Zurichat may also collect location
                    information from devices in accordance with the consent
                    process provided by your device. Cookie information.
                    Zurichat uses a variety of cookies and similar technologies
                    in our Websites and Services to help us collect Other
                    Information. For more details about how we use these
                    technologies, and your opt-out opportunities and other
                    options, please see our Cookie Policy. Third-Party services.
                    A Customer can choose to permit or restrict Third-Party
                    Services for its Workspace. Typically, Third-Party Services
                    are software that integrate with our Services, and a
                    Customer can permit its Authorized Users to enable and
                    disable these integrations for its Workspace. Zurichat may
                    also develop and offer Zurichat applications that connect
                    the Services with a Third-Party Service. Once enabled, the
                    provider of a Third-Party Service may share certain
                    information with
                  </p>{" "}
                </div>
              </div>
              ...
              <div className={Style.DataOthers}>
                ...
                <p className={Style.parOthers2}>
                  ...
                  our Services. We also may collect public information about
