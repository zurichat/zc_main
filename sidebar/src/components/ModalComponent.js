    ...
    <section className={`${isOpen ? styles.open : styles. modalCon}`}>
      ...
      <div className={`d-flex align-items-center justify-content-between ${styles.modalSection}`}>
        <div className={`${styles.info}`} >
            ...
            <p className={`${styles.infoP}`}>The workspace is currently on the free version of Zuri Chat.</p> 
            <span> see plans</span>
        </div >
      ...
      <div className={`d-flex flex-column ${styles.modalSection}`}>
        ...
        <div className={`d-flex align-items-center justify-content-between ${styles.popover}`}>
          <p >Customize HNGi8</p>
          <div>
      ...
      <hr className={styles.modalDivider} />
      <div ref={hoverRef} className={`d-flex align-items-center justify-content-between ${styles.modalSection}`}>
        <p>Tools</p>
        <div>
            <Arrow className={`${styles.arrow}`}/>
        </div>
        <div className={`${ isHovered ? styles.openmodalSubCon : styles.modalSubCon}`}>
            <div ref={hoverRef} className={`d-flex flex-column ${styles.modalSection}`}>
                <p>Plugins</p>
                <hr className={styles.modalDivider} />
                <p>Analytics</p>
            </div>
      ...
      >
        <div className={`d-flex align-items-center justify-content-between ${styles.modalSubSection} `}>
        <p> Add workspace </p>
        <div>
        <Arrow className={`${styles.arrow}`}/>
        </div>
        </div>
        <div ref={hoverRef2}  className={`d-flex align-items-center justify-content-between ${styles.modalSubSection}`}>
        <p>Switch workspace</p>
        <Arrow className={`${styles.arrow}`}/>
        <div className={`${ isHovered2 ? styles.openmodalSubCon : styles.modalSubCon}`}>
            <div ref={hoverRef2} className={`d-flex flex-column ${styles.modalSection}`}>
                <p>HNGi8</p>
                <hr className={styles.modalDivider} />
                <p>The BrandHub</p>
            </div>
