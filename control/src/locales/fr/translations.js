export const TRANSLATIONS_FR = {
  ...
  plugin: {
    ...
    tracker: {
      ...
      headline: "Suivre les contributions des personnes et les points saillants des problèmes urgents",
      description:
    ...
    goal: {
      ...
      headline:
        "Gardez une trace des objectifs",
      description:
    ...
    todo: {
      ...
      headline:
        "Garde une trace des tâches importantes",
      description:
    ...
    channels: {
      ...
      headline:
        "Organise les conversations dans des espaces dédiés",
      description:
    ...
    noticeboard: {
      ...
      headline:
        "Partagez efficacement les informations",
      description:
    ...
    company_files: {
      ...
      headline:
        "Accéder et gérer efficacement les fichiers de l'entreprise",
      description:
    ...
    company_sales: {
      ...
      headline:
        "Garde une trace de l'enregistrement des ventes",
      description:
    ...
    whiteboard: {
      ...
      headline:
        "Partage d'idées et collaborations d'équipe",
      description:
    ...
    holiday: {
      ...
      headline:
        "Horaires Événements ou jours fériés pour le personnel",
      description:
    ...
    company_shift: {
      ...
      headline:
        "Surveille les heures de travail d'une entreprise",
      description:
    ...
    signup: {
      ...
      description: "Intégrez vos plugins préférés et obtenez une expérience plus excitante",
      link: "Découvrir plus",
    },
  ...
  download:{
    title: {
      download: "Téléchargements - Zuri Chat"
    },
    ...
    hero: {
      desktop: {
        title: "Zuri pour le bureau",
        mac_store_link: "Télécharger sur Mac App Store",
        ms_store_link: "Obtenez-le de Microsoft"
      },
      mobile: {
        title: "Zuri pour mobiles",
        apple_store_link: "Téléchargement sur App Store",
        play_store_link: "Obtenez le sur Google Play"
      },
    },
    links: {
      title: "Téléchargez et profitez de l'expérience Zuri Chat sur n'importe lequel de ces appareils",
    ...
    highlight: {
      title: "Même sensation, même équipe sur Zuri App !",
      link: "TÉLÉCHARGER POUR",
      link2: "TÉLÉCHARGER"
    },
  }
}
