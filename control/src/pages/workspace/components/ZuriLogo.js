...
const ZuriLogo = () => {
  return (
    ...
    >
      ...
      <rect className={`${styles.rotate_logo}`} width="18.9" height="19.9" x="6.3" fill="#00B87C" rx="1.1" />
      <rect className={`${styles.rotate_logo}`} width="18.9" height="19.9" y="22.7" fill="#FEA162" rx="1.1" />
      <rect
