...
const ZuriLogo = () => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="181" height="52" viewBox="0 0 181 52">
      ...
      <rect width="18.9" height="19.9" x="6.3" fill="#00B87C" rx="1.1"/>
      <rect width="18.9" height="19.9" y="22.7" fill="#FEA162" rx="1.1"/>
      <rect width="18.9" height="19.9" x="27.9" y="9.5" fill="#1A61DB" rx="1.1"/>
      <rect width="18.9" height="19.9" x="21.6" y="32.1" fill="#DC1AA3" rx="1.1"/>
    </svg>
  )
}
