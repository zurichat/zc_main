        ...
        <Container className={styles.formcontainer}>
            ...
            {complaints.length ? 
                ...
                <>{complaints.map((complain,idx)=>(
                    <Card key = {idx}>
                        <Card.Body  style={{ display: "flex", flexDirection: "space-inbetween" }}>
                        ...
                        <div className= 'col-7'>
                            ...
                            {complain.authorize ? 
                                <TiTick className= 'col-7' color="green" onClick={handleShow}  />
                                :null
                                }
            ...
            <Modal show={check} onHide={handleClose}>
                <Modal.Header>
                    ...
                    <AiOutlineClose color = "green" variant="secondary" onClick={handleClose} />
                </Modal.Header>
                <Modal.Body>Are you sure you want to authorize these penalties?</Modal.Body>
                <Modal.Footer>
