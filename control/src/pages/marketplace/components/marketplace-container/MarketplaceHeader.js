    ...
    >
      <Link to="/" className={`navbar-brand`}>
        ...
        <div className={styles.accountOwnerAvatar}>  
          { !user?.id && !currentWorkspace && <Link to="/login" className={styles.joinButton}>Login to An Account</Link>  }
          { user?.id && !currentWorkspace && <Link to="/choose-workspace" className={styles.joinButton}>Join an Organization</Link> }
          {
