    ...
    <>
      ...
      <section className={``}>
        <div
          ...
          <div className={ `${styles.images} text-center p-lg-4 pb-lg-0`}>
            ...
            <img
              ...
              alt="app screenshot"
            ></img>
            <div className={`${styles.buttondiv} p-lg-5 m-lg-5 mb-lg-0 p-md-3 m-md-3`}>
               <a href={exe.link} download={exe.name} className={styles.button1}>
                 <img className={`px-2`} src={icon} alt="download icon"></img>
              DOWNLOAD
            </a>
             <Link className={`${styles.plink} mt-lg-4 d-inline`} to="./download-app">Download for Windows?</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <section className={`${styles.bg}`}>
          <div
            className={`row p-5 m-5 mt-0`}>
            <div className={` ${styles.zuri} col`}>
              <h6 className={`${styles.h6zuri}`}>
                Why Zuri Chat App?
              </h6>
              <p className={`${styles.p1}`}>
                Never miss the seamless collaboration
                experience even on the go with the
                zuri chat pc, <a href="#" className={`${styles.mobile}`}>Android</a> and <a href="#" className={`${styles.mobile}`}>iOS</a> apps.
              </p>
            </div>
            <div className={`col`}>
               <img
