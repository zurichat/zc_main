  ...
  return (
    <div className="app bg-light pb-5">
      ...
      <div className="container py-5 d-flex">
        <img src={logo} alt="" />
        <h2 className="px-3">Change Workspace Name</h2>
      </div>

      <div className="container bg-white mb-5 px-5 rounded">
        <div className="row">
          <div className="col-sm-6">
            <h2 className="my-3">Workspace Name</h2>
            <p className="mb-5">
          ...
          <div className="col-sm-6">
            <form action="" method="post" className="pt-5">
              ...
              <button type="submit" className=" text-white px-5 py-3  border-0">
                Save Changes
              </button>
            </form>
          </div>
