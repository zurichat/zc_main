    ...
    return (
        <section className={`container my-5 ${css.sectionContainer}`}>
            <div className={`row`}>
                ...
                <div className={`col-md-6 col-sm-12 d-flex flex-column ${css.rightColumn}`}>
                    <div className={`mx-3 ${css.text}`}>
                        <h2 className={` ${css.heading2}`}>Be the First to get updates and exclusive offers from Zuri Chat</h2>
