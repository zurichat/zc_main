      ...
      <div className={Style.content}>
        ...
        <div className={Style.infoCollected}>
          ...
          <div className={Style.infoImage}>
            <img className={Style.bulb} src={yellowBulb} alt="Yellow Bulb" />
            <p className={Style.infopar1}>
              ...
              Workspace by a Customer (“Authorized Users”) routinely submit
              Customer Data to Zurichat when using the Services. Other
              Information. Zurichat also collects, generates and/or receives
              Other Information:
            </p>
          </div>
          <br />
          <div className={Style.privbreakdown1}>
            ...
            <p className={Style.paragraph}>
              ...
              these integrations for its Workspace. Zurichat may also develop
        ...
        <div className={Style.partnersAll}>
          <div className={Style.imagePart}>
            <img className={Style.handShake} src={handShake} alt="Hand shake" />
