  ...
  return (
    <>
      ...
      <input
        ...
        style={myStyle.inputfield}
      />
      <p style={myStyle.text}>People who can remove members from private channels: </p>
      <input
        type="text"
        className="form-control"
        id=""
        ...
        style={myStyle.inputfield}
      />
      <p style={myStyle.text}>People who can remove members from public channels: </p>
      <input
        type="text"
        className="form-control"
        id=""
        ...
        style={myStyle.inputfield}
      />
      <p style={myStyle.text}>People who can manage posting permissions in channels: </p>
      <input
        type="text"
        className="form-control"
        id=""
