...
const Guidelines = () => {
    return (
        <>
            ...
            <label style={myStyle.text}>Default guidelines</label><br/>
            <p style={myStyle.smalltext}>This could be your first name or nick name - however you’d like people to refer to you on Zuri Chat</p>
