  ...
  return (
    <section className={styles.history_tab_container}>
      <form onSubmit={handleSubmit}>
        ...
        <button className={`${styles.history_form_btn} ${styles.history_btn}`}>Go To</button>
      ...
      <div className={styles.history_header}>
        <div className={styles.history_btn_wrapper}>
          <button className={styles.history_btn}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="6" height="6" viewBox="0 0 6 6">
              <path stroke="#333" stroke-linecap="round" stroke-linejoin="round" d="M5 3H1M2.5 4.5 1 3l1.5-1.5"/>
            </svg> &nbsp;
            August 2021
          </button>
        </div>
