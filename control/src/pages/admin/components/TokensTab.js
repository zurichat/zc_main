    ...
    <div className={styles.container}>
      ...
      <div className={styles.overview}>
        ...
        <div className="d-flex justify-content-center">
          <p>MY ZURI TOKENS <span>{workspaceData.tokens}</span></p>
          <p>MY ZURI REFERAL TOKENS <span>0</span></p>
          <p>MY ZURI TOKENS PRICE<span>1.0 USD</span></p>
        </div>
        <div className="d-flex justify-content-center">
          <button className="btn" onClick={() => setHelpModal(true)}>Buy</button>
      ...
      <div>
        ...
        <div className={`${styles.referal} input-group`}>
          <input type="text" className="form-control" placeholder="https://ico.zuri.chat/?ref=49eb37c78185" aria-describedby="basic-addon2" />
        ...
        <div className={styles.rInfo}>
          <p>
          This is your Zurichat referral link. You can use it to share the project with your friends and other 
          interested parties. If any of them sign up with this link they will be added to your referral program. 
          Your reward amounts to 5% of all Zuri tokens bought by your referrals.
        </p>
        </div>
        <div>
          <h6>Payments</h6>
